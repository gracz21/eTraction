    ...
    context 'with device identifier included in request headers' do
      context 'with valid params' do
        context 'when device is already registered' do
          ...
          before { post '/api/v1/users', params: user_params, headers: { 'Device-Id' => user.device_id } }
        ...
        context 'when device is not registered' do
          ...
          before { post '/api/v1/users', params: user_params, headers: { 'Device-Id' => unregistered_device_id } }
    ...
    context 'with device identifier included in request headers' do
      context 'when device is already registered' do
        ...
        context 'with valid params' do
          ...
          before { put '/api/v1/users', params: user_params, headers: { 'Device-Id' => user.device_id } }
        ...
        context 'with invalid params' do
          ...
          before { put '/api/v1/users', params: wrong_user_params, headers: { 'Device-Id' => user.device_id } }
